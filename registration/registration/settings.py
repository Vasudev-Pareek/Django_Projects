...
SECRET_KEY = 'django-insecure-12!(vp+d95v*c8-x&3g%+^)mps+rval!y8m-y_afnl-lp04_6t'
...
#         'NAME': 'login_signup',         # Your manually created database name
...
DATABASES = {
    'default': {
        ...
        'NAME': 'registerData',  # Replace with your database name
